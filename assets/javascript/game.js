$(document).ready(function(){
	...
	function fight(){
		...
		if(hasYourCharacter && hasEnemy && lockAttack === false && roundIsOver === false){
			...
			$("#attack").on("click", function(){
				...
				$(".message-area").empty();	
				$(".message-area").html("<p>You attacked "
										+ enemy.name +
										" for "
										+ yourAttackPower +
										".</p><p>"
				...
				if(you.health <= 0){
					...
					$(".your-pts").html(you.health);
					$(".enemy-pts").html(enemy.health);
					$(".message-area").html("<p><strong>You've been defeated by "
											+ enemy.name + 
				...
				if(enemy.health <= 0){
					...
					$(".your-pts").html(you.health);
					$(".enemy-pts").html(enemy.health);	
					$(".message-area").html("<p><strong>You have defeated " 
											+ enemy.name + 
